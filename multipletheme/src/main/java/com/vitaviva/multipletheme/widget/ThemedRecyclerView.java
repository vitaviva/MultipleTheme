...
public class ThemedRecyclerView extends RecyclerView implements ThemeUiInterface {
    ...
    public ThemedRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
